...
import com.intersec.androidapp.core.runtime.RustRuntimeLoader
import dalvik.annotation.optimization.FastNative

/**
 * Camada de baixo nível que realiza as chamadas nativas (JNI) para o Core em Rust.
 * Otimizada com @FastNative para transições de baixa latência.
 */
class RustBridgeClient(
    private val loader: RustRuntimeLoader = RustRuntimeLoader,
) {
    ...
    fun queryPackets(query: RustPacketQuery): String {
        loader.ensureLoaded()
    ...
    fun queryFlows(query: RustFlowQuery): String {
        loader.ensureLoaded()
    ...
    /**
     * Entrega o controle do túnel VPN para o motor Rust.
     */
