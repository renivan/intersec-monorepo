...
data class CaptureRealtimeUiState(
    ...
    val networkInterface: String = "Detectando...",
    val networkName: String = "Desconectado",
    val filter: String = "",
    val filterInput: String = "",
    val isLiveUpdate: Boolean = true,
    val isLoading: Boolean = false,
    val isVpnAuthorized: Boolean = false,
    val showVpnTerms: Boolean = false,
    val availableInterfaces: List<com.intersec.androidapp.core.network.NetworkInfo> = emptyList(),
