...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_pingNative(
    mut env: JNIEnv,
    _class: JClass,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_openCaptureNative(
    mut env: JNIEnv,
    _class: JClass,
    path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_snapshotActiveNative(
    mut env: JNIEnv,
    _class: JClass,
) -> jstring {
    let adapter = ADAPTER.lock().unwrap();
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_queryPacketsNative(
    mut env: JNIEnv,
    _class: JClass,
    protocol: JString,
    host: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_queryFlowsNative(
    mut env: JNIEnv,
    _class: JClass,
    protocol: JString,
    host: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_persistActiveNative(
    mut env: JNIEnv,
    _class: JClass,
    tags_csv: JString,
    notes: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_integration_rust_RustBridgeClient_00024Native_listStoredSessionsNative(
    mut env: JNIEnv,
    _class: JClass,
) -> jstring {
    let adapter = ADAPTER.lock().unwrap();
