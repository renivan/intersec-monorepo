...
// Macro para Log Facilitado via JNI - VersÃ£o EstÃ¡vel 2.0
macro_rules! guardian_log {
    ($env:expr, $module:expr, $msg:expr) => {
        if let Ok(log_class) = $env.find_class("com/intersec/androidapp/core/log/GuardianLogger") {
            if let Ok(module_str) = $env.new_string($module) {
                if let Ok(msg_str) = $env.new_string($msg) {
                    // Chama a versÃ£o simplificada do log para evitar crash de assinatura
        ...
        // Limpa qualquer exceÃ§Ã£o pendente para evitar o crash SIGABRT
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_pingNative(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_openCaptureNative(
    mut env: JNIEnv,
    _class: JClass,
    path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_snapshotActiveNative(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
    let runtime = RUNTIME.lock().unwrap();
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_queryPacketsNative(
    mut env: JNIEnv,
    _class: JClass,
    protocol: JString,
    host: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_queryFlowsNative(
    mut env: JNIEnv,
    _class: JClass,
    protocol: JString,
    host: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_persistActiveNative(
    mut env: JNIEnv,
    _class: JClass,
    tags_csv: JString,
    notes: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_listStoredSessionsNative(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
    let runtime = RUNTIME.lock().unwrap();
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_getCaptureOverviewNative(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
    let runtime = RUNTIME.lock().unwrap();
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_startCaptureNative(
    mut env: JNIEnv,
    _class: JClass,
    iface: JString,
    filter: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_stopCaptureNative(
    mut env: JNIEnv,
    _class: JClass,
    session_id: JString,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_capturePacketsNative(
    env: JNIEnv,
    _class: JClass,
    _session_id: JString,
    limit: i32,
    ...
    let output = match result {
        Ok(res) => {
            // Ajustado para usar o tipo correto e a funÃ§Ã£o de codificaÃ§Ã£o correta
            let kotlin_res = kotlin::dto::KotlinPacketSearchResult {
                items: res.into_iter().map(Into::into).collect(),
                total_items: 0, // Durante a captura viva, o total Ã© dinÃ¢mico
            };
            kotlin::encode_packet_result_text(&kotlin_res)
        },
        Err(e) => format!("ERROR: {:?}", e),
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_runFullSystemTestNative(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
    let runtime = RUNTIME.lock().unwrap();
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_attachVpnTunnelNative(
    mut _env: JNIEnv,
    _class: JClass,
    fd: i32,
) -> jboolean {
    ...
    guardian_log!(_env, "JNI_BRIDGE", format!("Tentativa de conexÃ£o de tÃºnel no FD: {}", fd));

    match runtime.attach_vpn_tunnel(fd) {
        Ok(_) => {
            guardian_log!(_env, "JNI_BRIDGE", "TÃºnel VPN conectado ao Motor Native com sucesso.");
            1
        },
        Err(e) => {
            guardian_log!(_env, "JNI_BRIDGE", format!("ERRO: Falha ao conectar tÃºnel: {:?}", e));
            0
        },
    }
}
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_updateThreatDatabaseNative(
    mut _env: JNIEnv,
    _class: JClass,
...
#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_simulateAttackNative(
    mut _env: JNIEnv,
    _class: JClass,
    data: jni::objects::JByteArray,
) -> jni::sys::jstring {
    ...
    let verdict = runtime.simulate_attack(bytes);
    _env.new_string(verdict).unwrap().into_raw()
}

#[no_mangle]
pub extern "system" fn Java_com_intersec_androidapp_core_bridge_NativeBridgeClient_00024Native_updateSecuritySettingsNative(
    mut _env: JNIEnv,
    _class: JClass,
    level: jint,
    smart_shield: jboolean,
    kill_switch: jboolean,
) -> jboolean {
    let runtime = RUNTIME.lock().unwrap();
    match runtime.update_security_settings(level as u8, smart_shield != 0, kill_switch != 0) {
