...
impl NetworkNeuralIntelligence {
    ...
    pub fn process_neural_event(&mut self, packet: &ParsedPacket) {
        ...
        // Atualiza ou cria o nÃ³ neural para a origem
        ...
        // LÃ³gica de InteligÃªncia: Se houver RST frequente, aumenta o threat level
...
fn extract_ip(packet: &ParsedPacket, is_src: Boolean) -> String {
    // Busca nos campos decodificados pelo motor Native
